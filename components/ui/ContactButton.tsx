...
export default function ContactButton({ label, url, id, isPrimary }: ContactButtonProps) {
  return (
    <a
      ...
      className={`px-6 py-3 rounded-lg font-medium transition-all duration-200 inline-flex items-center justify-center gap-2 ${isPrimary
